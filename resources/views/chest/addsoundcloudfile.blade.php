                      ...
                      <div class="row">
                            <div class="col-md-7 col-md-offset-2">
                                <div class="panel panel-default">
                                        ...
                                        <div class="panel-heading" onclick="getSoundcloudInfo(this)" data-title="{{$song->title}}" data-url="{{$song->url}}" data-embed="{{$song->embedurl}}">
                                            <a href="{{$song->url}}">
                                            {{ $song->title }}
                                            </a>
                                        </div>
                                        <div class="panel-body embed-responsive embed-responsive-16by9" >
                                        <iframe width="100%" height="166" scrolling="no" frameborder="no" src="https://w.soundcloud.com/player/?url={{$song->embedurl}}&amp;color=ff6600&amp;auto_play=false&amp;show_artwork=true"></iframe>
